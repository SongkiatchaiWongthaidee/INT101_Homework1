...
public class Int101Homework01 {
    ...
    static void work03UseOfUtilityClass() {
      ...
      3.2 Create a method named "calculateBMMyUtil" in package named "work03".
      3.2 Create a method named "I" in "MyUtil" class. 
      ...
      */
        ...
        double bmi = MyUtil.I(weight, height);
    ...
    static void work04UseOfObjectClass() {
      ...
      */
        ...
        BankAccount account1 = new BankAccount(1410, person1);
        BankAccount account2 = new BankAccount(1520, person2);
        System.out.println("Account 1 : " + account1.toString());
        System.out.println("Account 2 : " + account2.toString());

        account1.deposit(1000);
        System.out.println(account1.toString() + "Balance after deposite: " + account1.getBalance());
        account1.withdraw(500);
        System.out.println(account1.toString() + "Balance after withdraw: " + account1.getBalance());
        
        account1.transfer(200, account2);
        System.out.println(account1.toString() + "Balance after transfer: " + account1.getBalance());
        System.out.println(account2.toString() + "Balance after transfer: " + account2.getBalance());
   }
}
